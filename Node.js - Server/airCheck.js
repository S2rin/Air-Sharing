...
var sid = 0; //timeout용
var timer = 30000; //타이머 defualt 값은 30분
...
const timerSet = function(){
  ...
  gpio.digitalWrite(BLUE, 0);
  gpio.digitalWrite(LED, 0);
  setTimeout(button_handler, timer); //default 값 30분 간격
  //setTimeout(button_handler, sid); //sid 값으로 타이머 설정
}
