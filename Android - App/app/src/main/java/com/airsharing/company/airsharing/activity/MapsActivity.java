    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mMap.clear();
                Call<ArrayList> openData = apiService.get_dust();

                openData.enqueue(new Callback<ArrayList>() {
                    @Override
                    public void onResponse(Call<ArrayList> call, Response<ArrayList> response) {
                        if(response.isSuccessful()){
                            ...
                            Log.i("Error","statusCode : " + statusCode);
                    ...
                    public void onFailure(Call<ArrayList> call, Throwable t) {
                        ...
                        Log.i("onFailure", "Error Message : " + t.getMessage());
                    }
                });
            ...
            public void onClick(View view) {
                ...
                data.enqueue(new Callback<List<AirData>>() {
                    ...
                    public void onResponse(Call<List<AirData>> call, Response<List<AirData>> response) {
                        if(response.isSuccessful()){
                            Log.i("Success", "Response example: " + response.body().get(0).getLatitude() + " / " + response.body().get(0).getLongitude());
