...
public class LoginActivity extends AppCompatActivity {
    ...
    private static String OAUTH_CLIENT_ID = "gFXivAOYzwNAdM860COi";
    private static String OAUTH_CLIENT_SECRET = "EvTX1SXIJZ";
